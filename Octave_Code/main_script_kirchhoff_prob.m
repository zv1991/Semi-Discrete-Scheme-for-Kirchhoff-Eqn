...
m = 200; % Division number of the spatial interval %
##n = 2;
...
while k <= n + 1
  ...
  switch k
    case 1
      ...
      q_exact(k) = alpha(t(k)) + beta(t(k)) * intdu(t(k));
...
"q_exact","rel_error_q","max_rel_error_q","ell","T","m","n","node_t",...
"problem");
##save(matfile,"t","tau","x","h","delta","CondN2","val_u","app_u","q","err",...
##"q_exact","rel_error_q","max_rel_error_q","ell","T","m","n","problem");
%%%%%%%%%%%%%%%%%%%%%%%%%
